...
//}
//
//func (svc *ImageService) Media(key string, skipCache bool) (*model.Media, error) {
//	if svc.IsSolKey(key) {
...
//}
//
//func (svc *ImageService) writeFile(c *gin.Context, path string, media *model.Media) error {
...
//}
//
//func (svc *ImageService) fetchMissingImage(media *model.Media, cacheName string) error {
//	if media.ImageUri == "" {
